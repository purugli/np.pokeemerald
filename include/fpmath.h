#ifndef GUARD_FPMATH_H
#define GUARD_FPMATH_H

/* FP (fixed point) API copied from RHH's pokeemerald-expansion:
   https://github.com/rh-hideout/pokeemerald-expansion/blob/master/include/fpmath.h */
