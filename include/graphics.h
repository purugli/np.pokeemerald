...
extern const u32 gTrainerFrontPic_FRLGRed[];
extern const u32 gTrainerFrontPic_FRLGLeaf[];
extern const u32 gTrainerFrontPic_RubySapphireBrendan[];
extern const u32 gTrainerFrontPic_RubySapphireMay[];
extern const u32 gTrainerFrontPic_FRLGYoungster[];
extern const u32 gTrainerFrontPic_FRLGBugCatcher[];
extern const u32 gTrainerFrontPic_FRLGLass[];
extern const u32 gTrainerFrontPic_FRLGSailor[];
extern const u32 gTrainerFrontPic_FRLGCamper[];
extern const u32 gTrainerFrontPic_FRLGPicnicker[];
extern const u32 gTrainerFrontPic_FRLGPokeManiac[];
extern const u32 gTrainerFrontPic_FRLGSuperNerd[];
extern const u32 gTrainerFrontPic_FRLGHiker[];
extern const u32 gTrainerFrontPic_FRLGBiker[];
extern const u32 gTrainerFrontPic_FRLGBurglar[];
extern const u32 gTrainerFrontPic_FRLGEngineer[];
extern const u32 gTrainerFrontPic_FRLGFisherman[];
extern const u32 gTrainerFrontPic_FRLGSwimmerM[];
extern const u32 gTrainerFrontPic_FRLGCueBall[];
extern const u32 gTrainerFrontPic_FRLGGamer[];
extern const u32 gTrainerFrontPic_FRLGBeauty[];
extern const u32 gTrainerFrontPic_FRLGSwimmerF[];
extern const u32 gTrainerFrontPic_FRLGPsychicM[];
extern const u32 gTrainerFrontPic_FRLGRocker[];
extern const u32 gTrainerFrontPic_FRLGJuggler[];
extern const u32 gTrainerFrontPic_FRLGTamer[];
extern const u32 gTrainerFrontPic_FRLGBirdKeeper[];
extern const u32 gTrainerFrontPic_FRLGBlackBelt[];
extern const u32 gTrainerFrontPic_FRLGRivalEarly[];
extern const u32 gTrainerFrontPic_FRLGScientist[];
extern const u32 gTrainerFrontPic_FRLGLeaderGiovanni[];
extern const u32 gTrainerFrontPic_FRLGRocketGruntM[];
extern const u32 gTrainerFrontPic_FRLGCoolTrainerM[];
extern const u32 gTrainerFrontPic_FRLGCoolTrainerF[];
extern const u32 gTrainerFrontPic_FRLGEliteFourLorelei[];
extern const u32 gTrainerFrontPic_FRLGEliteFourBruno[];
extern const u32 gTrainerFrontPic_FRLGEliteFourAgatha[];
extern const u32 gTrainerFrontPic_FRLGEliteFourLance[];
extern const u32 gTrainerFrontPic_FRLGLeaderBrock[];
extern const u32 gTrainerFrontPic_FRLGLeaderMisty[];
extern const u32 gTrainerFrontPic_FRLGLeaderLtSurge[];
extern const u32 gTrainerFrontPic_FRLGLeaderErika[];
extern const u32 gTrainerFrontPic_FRLGLeaderKoga[];
extern const u32 gTrainerFrontPic_FRLGLeaderBlaine[];
extern const u32 gTrainerFrontPic_FRLGLeaderSabrina[];
extern const u32 gTrainerFrontPic_FRLGGentleman[];
extern const u32 gTrainerFrontPic_FRLGRivalLate[];
extern const u32 gTrainerFrontPic_FRLGChampionRival[];
extern const u32 gTrainerFrontPic_FRLGChanneler[];
extern const u32 gTrainerFrontPic_FRLGTwins[];
extern const u32 gTrainerFrontPic_FRLGCoolCouple[];
extern const u32 gTrainerFrontPic_FRLGYoungCouple[];
extern const u32 gTrainerFrontPic_FRLGCrushKin[];
extern const u32 gTrainerFrontPic_FRLGSisAndBro[];
extern const u32 gTrainerFrontPic_FRLGProfessorOak[];
extern const u32 gTrainerFrontPic_FRLGRocketGruntF[];
extern const u32 gTrainerFrontPic_FRLGPsychicF[];
extern const u32 gTrainerFrontPic_FRLGCrushGirl[];
extern const u32 gTrainerFrontPic_FRLGTuberF[];
extern const u32 gTrainerFrontPic_FRLGPokemonBreeder[];
extern const u32 gTrainerFrontPic_FRLGPokemonRangerM[];
extern const u32 gTrainerFrontPic_FRLGPokemonRangerF[];
extern const u32 gTrainerFrontPic_FRLGAromaLady[];
extern const u32 gTrainerFrontPic_FRLGRuinManiac[];
extern const u32 gTrainerFrontPic_FRLGLady[];
extern const u32 gTrainerFrontPic_FRLGPainter[];
extern const u32 gTrainerFrontPic_FRLGTuberM[];
...
extern const u16 gTrainerPalette_Expert[];
...
extern const u16 gTrainerPalette_FRLGRedLeaf[];
extern const u16 gTrainerPalette_RubySapphireBrendan[];
extern const u16 gTrainerPalette_RubySapphireMay[];
extern const u16 gTrainerPalette_FRLGYoungster[];
extern const u16 gTrainerPalette_FRLGBugCatcher[];
extern const u16 gTrainerPalette_FRLGLass[];
extern const u16 gTrainerPalette_FRLGSailor[];
extern const u16 gTrainerPalette_FRLGCamper[];
extern const u16 gTrainerPalette_FRLGPicnicker[];
extern const u16 gTrainerPalette_FRLGPokeManiac[];
extern const u16 gTrainerPalette_FRLGSuperNerd[];
extern const u16 gTrainerPalette_FRLGHiker[];
extern const u16 gTrainerPalette_FRLGBiker[];
extern const u16 gTrainerPalette_FRLGBurglar[];
extern const u16 gTrainerPalette_FRLGEngineer[];
extern const u16 gTrainerPalette_FRLGFisherman[];
extern const u16 gTrainerPalette_FRLGSwimmerM[];
extern const u16 gTrainerPalette_FRLGCueBall[];
extern const u16 gTrainerPalette_FRLGGamer[];
extern const u16 gTrainerPalette_FRLGBeauty[];
extern const u16 gTrainerPalette_FRLGSwimmerF[];
extern const u16 gTrainerPalette_FRLGPsychic[];
extern const u16 gTrainerPalette_FRLGRocker[];
extern const u16 gTrainerPalette_FRLGJuggler[];
extern const u16 gTrainerPalette_FRLGTamer[];
extern const u16 gTrainerPalette_FRLGBirdKeeper[];
extern const u16 gTrainerPalette_FRLGRival[];
extern const u16 gTrainerPalette_FRLGScientist[];
extern const u16 gTrainerPalette_FRLGLeaderGiovanni[];
extern const u16 gTrainerPalette_FRLGTeamRocket[];
extern const u16 gTrainerPalette_FRLGCoolTrainer[];
extern const u16 gTrainerPalette_FRLGEliteFourLorelei[];
extern const u16 gTrainerPalette_FRLGEliteFourBruno[];
extern const u16 gTrainerPalette_FRLGEliteFourAgatha[];
extern const u16 gTrainerPalette_FRLGEliteFourLance[];
extern const u16 gTrainerPalette_FRLGLeaderBrock[];
extern const u16 gTrainerPalette_FRLGLeaderMisty[];
extern const u16 gTrainerPalette_FRLGLeaderLtSurge[];
extern const u16 gTrainerPalette_FRLGLeaderErika[];
extern const u16 gTrainerPalette_FRLGLeaderKoga[];
extern const u16 gTrainerPalette_FRLGLeaderBlaine[];
extern const u16 gTrainerPalette_FRLGLeaderSabrina[];
extern const u16 gTrainerPalette_FRLGGentleman[];
extern const u16 gTrainerPalette_FRLGChanneler[];
extern const u16 gTrainerPalette_FRLGTwins[];
extern const u16 gTrainerPalette_FRLGYoungCouple[];
extern const u16 gTrainerPalette_FRLGCrushKin[];
extern const u16 gTrainerPalette_FRLGProfessorOak[];
extern const u16 gTrainerPalette_FRLGCrushGirl[];
extern const u16 gTrainerPalette_FRLGTuber[];
extern const u16 gTrainerPalette_FRLGPokemonBreeder[];
extern const u16 gTrainerPalette_FRLGPokemonRanger[];
extern const u16 gTrainerPalette_FRLGAromaLady[];
extern const u16 gTrainerPalette_FRLGRuinManiac[];
extern const u16 gTrainerPalette_FRLGLady[];
extern const u16 gTrainerPalette_FRLGPainter[];

extern const u8 gTrainerBackPic_Brendan[];
extern const u8 gTrainerBackPic_May[];
extern const u8 gTrainerBackPic_FRLGRed[];
extern const u8 gTrainerBackPic_FRLGLeaf[];
extern const u8 gTrainerBackPic_FRLGPokedude[];
extern const u8 gTrainerBackPic_FRLGOldMan[];
...
extern const u16 gTrainerBackPicPalette_FRLGRedLeaf[];
extern const u16 gTrainerBackPicPalette_FRLGPokedude[];
extern const u16 gTrainerBackPicPalette_FRLGOldMan[];
...
extern const u16 gObjectEventPal_FRLGRedLeaf[];
