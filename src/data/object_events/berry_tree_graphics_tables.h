...
static const u16 sBerryTreePaletteTagTable_Pecha[] = {
    ...
    [BERRY_STAGE_SPROUTED - 1] = OBJ_EVENT_PAL_TAG_CUSTOM_BERRY_TREE_SPROUT,
...
static const u16 sBerryTreePaletteTagTable_Cheri[] = {
    [BERRY_STAGE_PLANTED - 1] = OBJ_EVENT_PAL_TAG_NPC_2,
    [BERRY_STAGE_SPROUTED - 1] = OBJ_EVENT_PAL_TAG_CUSTOM_BERRY_TREE_SPROUT,
    [BERRY_STAGE_TALLER - 1] = OBJ_EVENT_PAL_TAG_CUSTOM_BERRY_TREE_SPROUT,
    [BERRY_STAGE_FLOWERING - 1] = OBJ_EVENT_PAL_TAG_CUSTOM_BERRY_TREE_SPROUT,
    [BERRY_STAGE_BERRIES - 1] = OBJ_EVENT_PAL_TAG_CUSTOM_BERRY_TREE_SPROUT,
};
...
static const u16 sBerryTreePaletteTagTable_Aguav[] = {
    [BERRY_STAGE_PLANTED - 1] = OBJ_EVENT_PAL_TAG_NPC_2,
    [BERRY_STAGE_SPROUTED - 1] = OBJ_EVENT_PAL_TAG_CUSTOM_BERRY_TREE_SPROUT,
    [BERRY_STAGE_TALLER - 1] = OBJ_EVENT_PAL_TAG_CUSTOM_AGUAV_BERRY_TREE,
    [BERRY_STAGE_FLOWERING - 1] = OBJ_EVENT_PAL_TAG_CUSTOM_AGUAV_BERRY_TREE,
    [BERRY_STAGE_BERRIES - 1] = OBJ_EVENT_PAL_TAG_CUSTOM_AGUAV_BERRY_TREE,
};
...
static const u16 sBerryTreePaletteTagTable_Salac[] = {
    [BERRY_STAGE_PLANTED - 1] = OBJ_EVENT_PAL_TAG_NPC_2,
    [BERRY_STAGE_SPROUTED - 1] = OBJ_EVENT_PAL_TAG_CUSTOM_BERRY_TREE_SPROUT,
    [BERRY_STAGE_TALLER - 1] = OBJ_EVENT_PAL_TAG_CUSTOM_SALAC_BERRY_TREE,
    [BERRY_STAGE_FLOWERING - 1] = OBJ_EVENT_PAL_TAG_CUSTOM_SALAC_BERRY_TREE,
    [BERRY_STAGE_BERRIES - 1] = OBJ_EVENT_PAL_TAG_CUSTOM_SALAC_BERRY_TREE,
};
