const u8 gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_RG_RED] = TRAINER_PIC_FRLG_RED,
    [FACILITY_CLASS_RG_LEAF] = TRAINER_PIC_FRLG_LEAF,
    ...
    [FACILITY_CLASS_RG_YOUNGSTER] = TRAINER_PIC_FRLG_YOUNGSTER,
    [FACILITY_CLASS_RG_BUG_CATCHER] = TRAINER_PIC_FRLG_BUG_CATCHER,
    [FACILITY_CLASS_RG_LASS] = TRAINER_PIC_FRLG_LASS,
    [FACILITY_CLASS_RG_SAILOR] = TRAINER_PIC_FRLG_SAILOR,
    [FACILITY_CLASS_RG_CAMPER] = TRAINER_PIC_FRLG_CAMPER,
    [FACILITY_CLASS_RG_PICNICKER] = TRAINER_PIC_FRLG_PICNICKER,
    [FACILITY_CLASS_RG_POKEMANIAC] = TRAINER_PIC_FRLG_POKEMANIAC,
    [FACILITY_CLASS_RG_SUPER_NERD] = TRAINER_PIC_FRLG_SUPER_NERD,
    [FACILITY_CLASS_RG_HIKER] = TRAINER_PIC_FRLG_HIKER,
    [FACILITY_CLASS_RG_BIKER] = TRAINER_PIC_FRLG_BIKER,
    [FACILITY_CLASS_RG_BURGLAR] = TRAINER_PIC_FRLG_BURGLAR,
    [FACILITY_CLASS_RG_ENGINEER] = TRAINER_PIC_FRLG_ENGINEER,
    [FACILITY_CLASS_RG_FISHERMAN] = TRAINER_PIC_FRLG_FISHERMAN,
    [FACILITY_CLASS_RG_SWIMMER_M] = TRAINER_PIC_FRLG_SWIMMER_M,
    [FACILITY_CLASS_RG_CUE_BALL] = TRAINER_PIC_FRLG_CUE_BALL,
    [FACILITY_CLASS_RG_GAMER] = TRAINER_PIC_FRLG_GAMER,
    [FACILITY_CLASS_RG_BEAUTY] = TRAINER_PIC_FRLG_BEAUTY,
    [FACILITY_CLASS_RG_SWIMMER_F] = TRAINER_PIC_FRLG_SWIMMER_F,
    [FACILITY_CLASS_RG_PSYCHIC_M] = TRAINER_PIC_FRLG_PSYCHIC_M,
    [FACILITY_CLASS_RG_ROCKER] = TRAINER_PIC_FRLG_ROCKER,
    [FACILITY_CLASS_RG_JUGGLER] = TRAINER_PIC_FRLG_JUGGLER,
    [FACILITY_CLASS_RG_TAMER] = TRAINER_PIC_FRLG_TAMER,
    [FACILITY_CLASS_RG_BIRD_KEEPER] = TRAINER_PIC_FRLG_BIRD_KEEPER,
    [FACILITY_CLASS_RG_BLACK_BELT] = TRAINER_PIC_FRLG_BLACK_BELT,
    [FACILITY_CLASS_RG_RIVAL_EARLY] = TRAINER_PIC_FRLG_RIVAL_EARLY,
    [FACILITY_CLASS_RG_SCIENTIST] = TRAINER_PIC_FRLG_SCIENTIST,
    [FACILITY_CLASS_RG_BOSS] = TRAINER_PIC_FRLG_LEADER_GIOVANNI,
    [FACILITY_CLASS_RG_ROCKET_GRUNT_M] = TRAINER_PIC_FRLG_ROCKET_GRUNT_M,
    [FACILITY_CLASS_RG_COOLTRAINER_M] = TRAINER_PIC_FRLG_COOLTRAINER_M,
    [FACILITY_CLASS_RG_COOLTRAINER_F] = TRAINER_PIC_FRLG_COOLTRAINER_F,
    [FACILITY_CLASS_RG_ELITE_FOUR_LORELEI] = TRAINER_PIC_FRLG_ELITE_FOUR_LORELEI,
    [FACILITY_CLASS_RG_ELITE_FOUR_BRUNO] = TRAINER_PIC_FRLG_ELITE_FOUR_BRUNO,
    [FACILITY_CLASS_RG_LEADER_BROCK] = TRAINER_PIC_FRLG_LEADER_BROCK,
    [FACILITY_CLASS_RG_LEADER_MISTY] = TRAINER_PIC_FRLG_LEADER_MISTY,
    [FACILITY_CLASS_RG_GENTLEMAN] = TRAINER_PIC_FRLG_GENTLEMAN,
    [FACILITY_CLASS_RG_RIVAL_LATE] = TRAINER_PIC_FRLG_RIVAL_LATE,
    [FACILITY_CLASS_RG_CHAMPION_RIVAL] = TRAINER_PIC_FRLG_CHAMPION_RIVAL,
    [FACILITY_CLASS_RG_CHANNELER] = TRAINER_PIC_FRLG_CHANNELER,
    [FACILITY_CLASS_RG_TWINS] = TRAINER_PIC_FRLG_TWINS,
    [FACILITY_CLASS_RG_COOL_COUPLE] = TRAINER_PIC_FRLG_COOL_COUPLE,
    [FACILITY_CLASS_RG_YOUNG_COUPLE] = TRAINER_PIC_FRLG_YOUNG_COUPLE,
    [FACILITY_CLASS_RG_CRUSH_KIN] = TRAINER_PIC_FRLG_CRUSH_KIN,
    [FACILITY_CLASS_RG_SIS_AND_BRO] = TRAINER_PIC_FRLG_SIS_AND_BRO,
    [FACILITY_CLASS_RG_PKMN_PROF] = TRAINER_PIC_FRLG_PROFESSOR_OAK,
    [FACILITY_CLASS_RG_ROCKET_GRUNT_F] = TRAINER_PIC_FRLG_ROCKET_GRUNT_F,
    [FACILITY_CLASS_RG_PSYCHIC_F] = TRAINER_PIC_FRLG_PSYCHIC_F,
    [FACILITY_CLASS_RG_CRUSH_GIRL] = TRAINER_PIC_FRLG_CRUSH_GIRL,
    [FACILITY_CLASS_RG_TUBER] = TRAINER_PIC_FRLG_TUBER_F,
    [FACILITY_CLASS_RG_PKMN_BREEDER] = TRAINER_PIC_FRLG_POKEMON_BREEDER,
    [FACILITY_CLASS_RG_PKMN_RANGER_M] = TRAINER_PIC_FRLG_POKEMON_RANGER_M,
    [FACILITY_CLASS_RG_PKMN_RANGER_F] = TRAINER_PIC_FRLG_POKEMON_RANGER_F,
    [FACILITY_CLASS_RG_AROMA_LADY] = TRAINER_PIC_FRLG_AROMA_LADY,
    [FACILITY_CLASS_RG_RUIN_MANIAC] = TRAINER_PIC_FRLG_RUIN_MANIAC,
    [FACILITY_CLASS_RG_LADY] = TRAINER_PIC_FRLG_LADY,
    [FACILITY_CLASS_RG_PAINTER] = TRAINER_PIC_FRLG_PAINTER,
};
