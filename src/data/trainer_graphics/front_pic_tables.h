...
#define TRAINER_PAL(trainerPic, pal) [TRAINER_PIC_##trainerPic] = pal

const u16 *const gTrainerFrontPicPaletteTable[] =
{
    ...
    TRAINER_PAL(MAGMA_GRUNT_M, gTrainerPalette_TeamMagma),
    TRAINER_PAL(EXPERT_M, gTrainerPalette_OldCouple),
    ...
    TRAINER_PAL(EXPERT_F, gTrainerPalette_OldCouple),
    TRAINER_PAL(POKEMANIAC, gTrainerPalette_Pokemaniac),
    TRAINER_PAL(MAGMA_GRUNT_F, gTrainerPalette_TeamMagma),
    TRAINER_PAL(GUITARIST, gTrainerPalette_Guitarist),
    TRAINER_PAL(KINDLER, gTrainerPalette_Kindler),
    TRAINER_PAL(CAMPER, gTrainerPalette_Picnicker),
    ...
    TRAINER_PAL(RUNNING_TRIATHLETE_F, gTrainerPalette_SwimmingTriathleteF),
    TRAINER_PAL(SWIMMING_TRIATHLETE_M, gTrainerPalette_SwimmingTriathleteF),
    ...
    TRAINER_PAL(SWIMMER_F, gTrainerPalette_SisAndBro),
    TRAINER_PAL(TWINS, gTrainerPalette_Twins),
    TRAINER_PAL(SAILOR, gTrainerPalette_Sailor),
    TRAINER_PAL(MAGMA_ADMIN, gTrainerPalette_TeamMagma),
