...
const u16 gTilesetAnims_Mauville_Flower1_VDests[] = {
    NUM_TILES_IN_PRIMARY_EMERALD + 96,
    NUM_TILES_IN_PRIMARY_EMERALD + 100,
    NUM_TILES_IN_PRIMARY_EMERALD + 104,
    NUM_TILES_IN_PRIMARY_EMERALD + 108,
    NUM_TILES_IN_PRIMARY_EMERALD + 112,
    NUM_TILES_IN_PRIMARY_EMERALD + 116,
    NUM_TILES_IN_PRIMARY_EMERALD + 120,
    NUM_TILES_IN_PRIMARY_EMERALD + 124
};

const u16 gTilesetAnims_Mauville_Flower2_VDests[] = {
    NUM_TILES_IN_PRIMARY_EMERALD + 128,
    NUM_TILES_IN_PRIMARY_EMERALD + 132,
    NUM_TILES_IN_PRIMARY_EMERALD + 136,
    NUM_TILES_IN_PRIMARY_EMERALD + 140,
    NUM_TILES_IN_PRIMARY_EMERALD + 144,
    NUM_TILES_IN_PRIMARY_EMERALD + 148,
    NUM_TILES_IN_PRIMARY_EMERALD + 152,
    NUM_TILES_IN_PRIMARY_EMERALD + 156
};
...
const u16 gTilesetAnims_EverGrande_VDests[] = {
    NUM_TILES_IN_PRIMARY_EMERALD + 224,
    NUM_TILES_IN_PRIMARY_EMERALD + 228,
    NUM_TILES_IN_PRIMARY_EMERALD + 232,
    NUM_TILES_IN_PRIMARY_EMERALD + 236,
    NUM_TILES_IN_PRIMARY_EMERALD + 240,
    NUM_TILES_IN_PRIMARY_EMERALD + 244,
    NUM_TILES_IN_PRIMARY_EMERALD + 248,
    NUM_TILES_IN_PRIMARY_EMERALD + 252
};
...
static void QueueAnimTiles_Lavaridge_Steam(u8 timer)
{
    ...
    AppendTilesetAnimToBuffer(gTilesetAnims_Lavaridge_Steam[i], NUM_TILES_IN_PRIMARY_EMERALD + 288, 4 * TILE_SIZE_4BPP);

    i = (timer + 2) % (int)ARRAY_COUNT(gTilesetAnims_Lavaridge_Steam);
    AppendTilesetAnimToBuffer(gTilesetAnims_Lavaridge_Steam[i], NUM_TILES_IN_PRIMARY_EMERALD + 292, 4 * TILE_SIZE_4BPP);
}

static void QueueAnimTiles_Pacifidlog_LogBridges(u8 timer)
{
    u8 i = timer % ARRAY_COUNT(gTilesetAnims_Pacifidlog_LogBridges);
    AppendTilesetAnimToBuffer(gTilesetAnims_Pacifidlog_LogBridges[i], NUM_TILES_IN_PRIMARY_EMERALD + 464, 30 * TILE_SIZE_4BPP);
}

static void QueueAnimTiles_Underwater_Seaweed(u8 timer)
{
    u8 i = timer % ARRAY_COUNT(gTilesetAnims_Underwater_Seaweed);
    AppendTilesetAnimToBuffer(gTilesetAnims_Underwater_Seaweed[i], NUM_TILES_IN_PRIMARY_EMERALD + 496, 4 * TILE_SIZE_4BPP);
}
...
static void QueueAnimTiles_Pacifidlog_WaterCurrents(u8 timer)
{
    ...
    AppendTilesetAnimToBuffer(gTilesetAnims_Pacifidlog_WaterCurrents[i], NUM_TILES_IN_PRIMARY_EMERALD + 496, 8 * TILE_SIZE_4BPP);
}
...
static void QueueAnimTiles_Rustboro_WindyWater(u16 timer_div, u8 timer_mod)
{
    ...
    if (gTilesetAnims_Rustboro_WindyWater[timer_div])
        AppendTilesetAnimToBuffer(gTilesetAnims_Rustboro_WindyWater[timer_div], gTilesetAnims_Mauville_Flower2_VDests[timer_mod], 4 * TILE_SIZE_4BPP);
}

static void QueueAnimTiles_Rustboro_Fountain(u16 timer)
{
    u16 i = timer % ARRAY_COUNT(gTilesetAnims_Rustboro_Fountain);
    AppendTilesetAnimToBuffer(gTilesetAnims_Rustboro_Fountain[i], NUM_TILES_IN_PRIMARY_EMERALD + 448, 4 * TILE_SIZE_4BPP);
}

static void QueueAnimTiles_Lavaridge_Lava(u16 timer)
{
    u16 i = timer % ARRAY_COUNT(gTilesetAnims_Lavaridge_Cave_Lava);
    AppendTilesetAnimToBuffer(gTilesetAnims_Lavaridge_Cave_Lava[i], NUM_TILES_IN_PRIMARY_EMERALD + 160, 4 * TILE_SIZE_4BPP);
}
...
{
    u16 i = timer % ARRAY_COUNT(gTilesetAnims_Lavaridge_Cave_Lava);
    AppendTilesetAnimToBuffer(gTilesetAnims_Lavaridge_Cave_Lava[i], NUM_TILES_IN_PRIMARY_EMERALD + 416, 4 * TILE_SIZE_4BPP);
}

static void QueueAnimTiles_Dewford_Flag(u16 timer)
{
    u16 i = timer % ARRAY_COUNT(gTilesetAnims_Dewford_Flag);
    AppendTilesetAnimToBuffer(gTilesetAnims_Dewford_Flag[i], NUM_TILES_IN_PRIMARY_EMERALD + 170, 6 * TILE_SIZE_4BPP);
}
...
static void QueueAnimTiles_BattleFrontierOutsideWest_Flag(u16 timer)
{
    ...
    AppendTilesetAnimToBuffer(gTilesetAnims_BattleFrontierOutsideWest_Flag[i], NUM_TILES_IN_PRIMARY_EMERALD + 218, 6 * TILE_SIZE_4BPP);
}
...
static void QueueAnimTiles_BattleFrontierOutsideEast_Flag(u16 timer)
{
    ...
    AppendTilesetAnimToBuffer(gTilesetAnims_BattleFrontierOutsideEast_Flag[i], NUM_TILES_IN_PRIMARY_EMERALD + 218, 6 * TILE_SIZE_4BPP);
}

static void QueueAnimTiles_Slateport_Balloons(u16 timer)
{
    u16 i = timer % ARRAY_COUNT(gTilesetAnims_Slateport_Balloons);
    AppendTilesetAnimToBuffer(gTilesetAnims_Slateport_Balloons[i], NUM_TILES_IN_PRIMARY_EMERALD + 224, 4 * TILE_SIZE_4BPP);
}
...
static void QueueAnimTiles_SootopolisGym_Waterfalls(u16 timer)
{
    ...
    AppendTilesetAnimToBuffer(gTilesetAnims_SootopolisGym_SideWaterfall[i], NUM_TILES_IN_PRIMARY_EMERALD + 496, 12 * TILE_SIZE_4BPP);
    AppendTilesetAnimToBuffer(gTilesetAnims_SootopolisGym_FrontWaterfall[i], NUM_TILES_IN_PRIMARY_EMERALD + 464, 20 * TILE_SIZE_4BPP);
}

static void QueueAnimTiles_EliteFour_WallLights(u16 timer)
{
    u16 i = timer % ARRAY_COUNT(gTilesetAnims_EliteFour_WallLights);
    AppendTilesetAnimToBuffer(gTilesetAnims_EliteFour_WallLights[i], NUM_TILES_IN_PRIMARY_EMERALD + 504, 1 * TILE_SIZE_4BPP);
}

static void QueueAnimTiles_EliteFour_GroundLights(u16 timer)
{
    u16 i = timer % ARRAY_COUNT(gTilesetAnims_EliteFour_FloorLight);
    AppendTilesetAnimToBuffer(gTilesetAnims_EliteFour_FloorLight[i], NUM_TILES_IN_PRIMARY_EMERALD + 480, 4 * TILE_SIZE_4BPP);
}
...
static void QueueAnimTiles_MauvilleGym_ElectricGates(u16 timer)
{
    ...
    AppendTilesetAnimToBuffer(gTilesetAnims_MauvilleGym_ElectricGates[i], NUM_TILES_IN_PRIMARY_EMERALD + 144, 16 * TILE_SIZE_4BPP);
}
...
static void QueueAnimTiles_BikeShop_BlinkingLights(u16 timer)
{
    ...
    AppendTilesetAnimToBuffer(gTilesetAnims_BikeShop_BlinkingLights[i], NUM_TILES_IN_PRIMARY_EMERALD + 496, 9 * TILE_SIZE_4BPP);
}

static void QueueAnimTiles_Sootopolis_StormyWater(u16 timer)
{
    u16 i = timer % ARRAY_COUNT(gTilesetAnims_Sootopolis_StormyWater);
    AppendTilesetAnimToBuffer(gTilesetAnims_Sootopolis_StormyWater[i], NUM_TILES_IN_PRIMARY_EMERALD + 240, 96 * TILE_SIZE_4BPP);
}

static void QueueAnimTiles_BattlePyramid_Torch(u16 timer)
{
    u16 i = timer % ARRAY_COUNT(gTilesetAnims_BattlePyramid_Torch);
    AppendTilesetAnimToBuffer(gTilesetAnims_BattlePyramid_Torch[i], NUM_TILES_IN_PRIMARY_EMERALD + 151, 8 * TILE_SIZE_4BPP);
}
...
static void QueueAnimTiles_BattlePyramid_StatueShadow(u16 timer)
{
    ...
    AppendTilesetAnimToBuffer(gTilesetAnims_BattlePyramid_StatueShadow[i], NUM_TILES_IN_PRIMARY_EMERALD + 135, 8 * TILE_SIZE_4BPP);
}
